...
For convenience and advanced analysis, the posterior samples are saved in `lilace_output/posterior_samples.rds`. They can be analyzed further with the `posterior` package. Here is an example of how to access them:
```{r, warning=FALSE, message=FALSE}
library(posterior)
