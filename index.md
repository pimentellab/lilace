...
![](reference/figures/lilace-logo.png)
...
input password to login. From there, you can call
[`library(lilace)`](https://github.com/jermoef/lilace) and check that
you can run the intro vignette code.
